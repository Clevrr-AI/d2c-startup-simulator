...
const GameContainer: React.FC = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: `url(/background.png)`, backgroundSize: 'cover', backgroundPosition: 'bottom', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed' }}>
      <div className="container mx-auto">
        <div className="container bg-white text-blue-600 mx-auto rounded p-3 flex justify-between">
          <img src="/logo.png" alt="D2C Simulator Logo" className="w-32 mr-2" />
